...
Adds a home icon to Obsidian's left ribbon. Clicking it opens the native [Vault Control Center](https://github.com/jajuangarrett-ctrl/vault-control-center) plugin (v0.1.0 or later).
